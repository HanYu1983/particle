...
func OutputModel(w http.ResponseWriter, r *http.Request, page string, model interface{}) error {
	t, err := template.ParseFiles(page, "hanlib.org/mod/app/uploadcard/header.html", "hanlib.org/mod/app/uploadcard/htmlHeader.html")
	if err != nil {
		return err
	}
...
func OutputMessage(w http.ResponseWriter, message string) error {
	t, err := template.ParseFiles("hanlib.org/mod/app/uploadcard/message.html", "hanlib.org/mod/app/uploadcard/header.html", "hanlib.org/mod/app/uploadcard/htmlHeader.html")
	if err != nil {
		return err
	}
