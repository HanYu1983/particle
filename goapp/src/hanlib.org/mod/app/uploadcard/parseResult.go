...
func Serve_ParseResult(w http.ResponseWriter, r *http.Request) {
	...
	t, err := template.ParseFiles("hanlib.org/mod/app/uploadcard/parseResult.html", "hanlib.org/mod/app/uploadcard/header.html", "hanlib.org/mod/app/uploadcard/htmlHeader.html")
	tool.Assert(tool.IfError(err))
