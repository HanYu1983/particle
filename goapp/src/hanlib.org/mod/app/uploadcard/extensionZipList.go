...
func Serve_ExtensionZipList(w http.ResponseWriter, r *http.Request) {
	...
	t, err := template.ParseFiles("hanlib.org/mod/app/uploadcard/extensionZipList.html", "hanlib.org/mod/app/uploadcard/header.html", "hanlib.org/mod/app/uploadcard/htmlHeader.html")
	if err != nil {
		tool.Assert(tool.IfError(err))
	}
