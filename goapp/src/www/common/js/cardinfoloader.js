...
(function (module) {
  function load(game, lang, onLoadGameCallback) {
    switch (game) {
      ...
      case "gundamCrossWar":
        gundamCrossWar.load(
          "../common/txt/gundamCrossWarJp.json",
          onLoadGameCallback
        );
        break;
      case "sengoku":
  ...
  function cardimageurl(game, id) {
    switch (game) {
      case "finalfantasy": {
        ...
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/finalfantasy/" +
          id +
          "_eg.jpg"
        );
      }
      case "pokemon":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/pokemon/" +
          id
        );
      case "gundamCrossWar":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/gundamCrossWar/" +
          id +
          ".png"
        );
      case "sanguosha":
      ...
      case "sengoku":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/sengoku/" +
          id
        );
      case "ws":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/ws/" + id
        );
      case "sgs":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/sgs/" +
          id +
          ".jpg"
        );
      case "gundamWarN":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/gundamWarN/" +
          id +
          ".jpg"
        );
      case "dragonZ":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/dragonZ/" +
          id +
          ".jpg"
        );
      case "crusade":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/crusade/" +
          id +
          ".jpg"
        );
      case "battleSpirits":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/battleSpirits/" +
          id +
          ".jpg"
        );
      case "sangoWar":
        ...
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/sangoWar/" +
          id
        );
      case "gundamWar":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/gundamWar/" +
          id
        );
      case "yugioh":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/yugioh/" +
          id +
          ".jpg"
        );
      case "army":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/army/" +
          id +
          ".jpg"
        );
      case "fighter":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/fighter/" +
          id +
          ".png"
        );
      ...
      case "magic":
        return (
          "//storage.googleapis.com/particle-resources/cardPackage/magic/" +
