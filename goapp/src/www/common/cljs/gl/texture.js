...
*/
gl.texture.parameterTexMode = (function parameterTexMode(gl__$1,sm,tm){gl__$1.texParameteri(gl__$1.TEXTURE_2D,gl__$1.TEXTURE_WRAP_S,sm);
return gl__$1.texParameteri(gl__$1.TEXTURE_2D,gl__$1.TEXTURE_WRAP_T,tm);
});
/**
* 貼圖被放大時使用線性內插 | 貼圖被放大時使用線性內插 | webgl預設是repeat模式
*/
gl.texture.parameterDefault = (function parameterDefault(gl__$1){gl__$1.texParameteri(gl__$1.TEXTURE_2D,gl__$1.TEXTURE_MAG_FILTER,gl__$1.LINEAR);
...
gl.texture.texture = (function texture(gl__$1,img){var tex = gl__$1.createTexture();gl__$1.bindTexture(gl__$1.TEXTURE_2D,tex);
...
gl.texture.bind = (function bind(gl__$1,tex,channel,loc){gl__$1.activeTexture((channel + gl__$1.TEXTURE0));
