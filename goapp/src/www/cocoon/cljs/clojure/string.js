...
{{
var G__21953 = cljs.core.pop.call(null,v__$1);
v__$1 = G__21953;
continue;
}
} else
...
{var pred__21957 = cljs.core._EQ_;var expr__21958 = limit;if(cljs.core.truth_(pred__21957.call(null,(1),expr__21958)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__21957.call(null,(2),expr__21958)))
...
var G__21960 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__21961 = (limit__$1 - (1));
var G__21962 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__21960;
limit__$1 = G__21961;
parts = G__21962;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___21964 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___21964))
{var replacement_21965 = temp__4124__auto___21964;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_21965)));
} else
{buffer.append(ch);
}
{
var G__21966 = (index + (1));
index = G__21966;
continue;
}
}
