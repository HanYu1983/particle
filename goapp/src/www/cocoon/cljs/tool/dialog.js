...
}),cljs.core.map.call(null,(function (p1__17472_SHARP_){return cljs.core.partition.call(null,length,length,null,p1__17472_SHARP_);
...
tool.dialog.step = (function step(p__17473){var map__17478 = p__17473;var map__17478__$1 = ((cljs.core.seq_QMARK_.call(null,map__17478))?cljs.core.apply.call(null,cljs.core.hash_map,map__17478):map__17478);var ctx = map__17478__$1;var state = cljs.core.get.call(null,map__17478__$1,new cljs.core.Keyword(null,"state","state",-1988618099));var curr_idx = cljs.core.get.call(null,map__17478__$1,new cljs.core.Keyword(null,"curr-idx","curr-idx",784577584));var curr_line = cljs.core.get.call(null,map__17478__$1,new cljs.core.Keyword(null,"curr-line","curr-line",277562410));var max_line = cljs.core.get.call(null,map__17478__$1,new cljs.core.Keyword(null,"max-line","max-line",-919688481));var message = cljs.core.get.call(null,map__17478__$1,new cljs.core.Keyword(null,"message","message",-406056002));var request_next = cljs.core.get.call(null,map__17478__$1,new cljs.core.Keyword(null,"request-next","request-next",-1281096497));var pred__17479 = cljs.core._EQ_;var expr__17480 = state;if(cljs.core.truth_(pred__17479.call(null,new cljs.core.Keyword(null,"typing","typing",1090632888),expr__17480)))
...
{if(cljs.core.truth_(pred__17479.call(null,new cljs.core.Keyword(null,"wait","wait",-260664777),expr__17480)))
{if(cljs.core.truth_(request_next))
...
{if(cljs.core.truth_(pred__17479.call(null,new cljs.core.Keyword(null,"next","next",-117701485),expr__17480)))
...
tool.dialog.showstr = (function showstr(p__17482){var map__17484 = p__17482;var map__17484__$1 = ((cljs.core.seq_QMARK_.call(null,map__17484))?cljs.core.apply.call(null,cljs.core.hash_map,map__17484):map__17484);var ctx = map__17484__$1;var curr_idx = cljs.core.get.call(null,map__17484__$1,new cljs.core.Keyword(null,"curr-idx","curr-idx",784577584));var curr_line = cljs.core.get.call(null,map__17484__$1,new cljs.core.Keyword(null,"curr-line","curr-line",277562410));var max_line = cljs.core.get.call(null,map__17484__$1,new cljs.core.Keyword(null,"max-line","max-line",-919688481));var message = cljs.core.get.call(null,map__17484__$1,new cljs.core.Keyword(null,"message","message",-406056002));var prevcount = cljs.core.mod.call(null,curr_line,max_line);var showstr__$1 = cljs.core.reduce.call(null,((function (prevcount,map__17484,map__17484__$1,ctx,curr_idx,curr_line,max_line,message){
...
});})(prevcount,map__17484,map__17484__$1,ctx,curr_idx,curr_line,max_line,message))
