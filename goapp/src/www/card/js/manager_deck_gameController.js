...
(function (module) {
  function getCardUrl(game, card) {
    switch (game) {
      case "sangoWar":
        return api.getCardImageWithPackageName(
          "sangoWar",
          sangoWar.formatKey(card.id)
        );
      default:
    ...
    for (var k in query) {
      ...
      switch (k) {
        case "cid":
          ...
          break;
        case "attackType":
          fns.push(cardsearch.attrEq("attackType", v));
          break;
        case "weight":
          fns.push(cardsearch.attrEq("weight", v));
          break;
        case "title":
          fns.push(cardsearch.attrEq("title", v));
          break;
        case "skillType":
          fns.push(cardsearch.attrEq("skillType", v));
          break;
        case "skillMana":
          fns.push(cardsearch.attrEq("skillMana", v));
          break;
        case "text":
          fns.push(
            cardsearch.or([
              cardsearch.attrEq("skillName", v),
              cardsearch.attrEq("skillText", v),
            ])
          );
          break;
      }
    ...
    for (var k in query) {
      ...
      switch (k) {
        ...
        case "rule":
          fns.push(
            cardsearch.or([
              cardsearch.attrEq("abi1", v),
              cardsearch.attrEq("abi2", v),
            ])
          );
          break;
        case "size":
        ...
        default:
          if (v == "on") {
            fns.push(
              cardsearch.or([
                cardsearch.attrEq("abi1", k),
                cardsearch.attrEq("abi2", k),
              ])
            );
          }
          break;
  ...
  function dragonZQuerystring2fns(qstr) {
    ...
    for (var k in query) {
      ...
      switch (k) {
        ...
        case "damage":
          fns.push(
            cardsearch.attrEq("descrition", "Damage: " + v + " life cards")
          );
          break;
        case "id":
          fns.push(cardsearch.attrEq("id", v));
    ...
    for (var k in query) {
      ...
      switch (k) {
        case "cid":
          ...
          fns.push(
            cardsearch.or([
              cardsearch.attrEq("cid", v),
              cardsearch.attrEq("id", v),
            ])
          );
          break;
        case "id":
