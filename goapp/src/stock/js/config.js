...
app.config.hoverInfo = {
	...
	line:{
		...
		'ma':'簡單平均線',
		'ema':'指數平均線',
		'bbi':'四條簡單平均線的平均<br>bbi(12,24,48,96)配合ebbi(6,12,24,48)的交叉買賣訊號還不錯的樣子',
		'ebbi':'四條指數平均線的平均<br>bbi(12,24,48,96)配合ebbi(6,12,24,48)的交叉買賣訊號還不錯的樣子',
		'macd':'N日和M日的指數均線差離',
		'AccDist':'越高代表資金流入越多，上漲動能越多；越低代表資金流出越多',
		...
		'kd':'N日的淨支撐起伏曲線',
		'atr':'可以當成價格的振蕩來看，越大代表趨勢越容易轉變，也越接近頭部或底部；越小代表順勢操做即可',
		'cv':'蔡金波動性指標。看法概念同atr',
