...
stock.formula.offset_seq = (function offset_seq(vs){return cljs.core.map.call(null,(function (p1__23667_SHARP_,p2__23666_SHARP_){return (p2__23666_SHARP_ - p1__23667_SHARP_);
...
*/
stock.formula.StandardDeviation = (function StandardDeviation(avg,vs){var v = Math.sqrt((((1) / (cljs.core.count.call(null,vs) - (1))) * cljs.core.apply.call(null,cljs.core._PLUS_,cljs.core.map.call(null,(function (p1__23668_SHARP_){return Math.pow((p1__23668_SHARP_ - avg),(2));
}),vs))));return v;
});
...
return (function (p1__23669_SHARP_){return (p1__23669_SHARP_ / sd);
});})(offsets))
...
return (function (p1__23670_SHARP_){return (p1__23670_SHARP_ / length.call(null,line));
...
return (function() { 
var G__23671__delegate = function (args){return (cljs.core.apply.call(null,cljs.core._PLUS_,args) / (4));
};
...
return (function() { 
var G__23673__delegate = function (args){return (cljs.core.apply.call(null,cljs.core._PLUS_,args) / (4));
};
...
{var low = cljs.core.apply.call(null,cljs.core.min,cljs.core.map.call(null,(function (p__23697){var vec__23698 = p__23697;var _ = cljs.core.nth.call(null,vec__23698,(0),null);var ___$1 = cljs.core.nth.call(null,vec__23698,(1),null);var ___$2 = cljs.core.nth.call(null,vec__23698,(2),null);var low = cljs.core.nth.call(null,vec__23698,(3),null);var ___$3 = cljs.core.nth.call(null,vec__23698,(4),null);var ___$4 = cljs.core.nth.call(null,vec__23698,(5),null);return low;
...
return (function (p__23699){var vec__23700 = p__23699;var value = cljs.core.nth.call(null,vec__23700,(0),null);var ori = cljs.core.nth.call(null,vec__23700,(1),null);var prev = cljs.core.nth.call(null,vec__23700,(2),null);var curr = cljs.core.nth.call(null,vec__23700,(3),null);var act = cljs.core.nth.call(null,vec__23700,(4),null);var af = cljs.core.nth.call(null,vec__23700,(5),null);var vec__23701 = cljs.core.first.call(null,prev);var _ = cljs.core.nth.call(null,vec__23701,(0),null);var ___$1 = cljs.core.nth.call(null,vec__23701,(1),null);var ph = cljs.core.nth.call(null,vec__23701,(2),null);var pl = cljs.core.nth.call(null,vec__23701,(3),null);var ___$2 = cljs.core.nth.call(null,vec__23701,(4),null);var ___$3 = cljs.core.nth.call(null,vec__23701,(5),null);var prev_line = vec__23701;var vec__23702 = cljs.core.first.call(null,curr);var ___$4 = cljs.core.nth.call(null,vec__23702,(0),null);var ___$5 = cljs.core.nth.call(null,vec__23702,(1),null);var ch = cljs.core.nth.call(null,vec__23702,(2),null);var cl = cljs.core.nth.call(null,vec__23702,(3),null);var ___$6 = cljs.core.nth.call(null,vec__23702,(4),null);var ___$7 = cljs.core.nth.call(null,vec__23702,(5),null);var curr_line = vec__23702;var should_turn = (function (){var pred__23703 = cljs.core._EQ_;var expr__23704 = act;if(cljs.core.truth_(pred__23703.call(null,new cljs.core.Keyword(null,"buy","buy",-794379565),expr__23704)))
{return (value > pl);
} else
{if(cljs.core.truth_(pred__23703.call(null,new cljs.core.Keyword(null,"sell","sell",-1949004143),expr__23704)))
{return (value < ph);
} else
{throw (new Error(("No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__23704))));
}
}
})();var next_value = ((should_turn)?(function (){var pred__23706 = cljs.core._EQ_;var expr__23707 = act;if(cljs.core.truth_(pred__23706.call(null,new cljs.core.Keyword(null,"buy","buy",-794379565),expr__23707)))
{return cljs.core.apply.call(null,cljs.core.max,cljs.core.map.call(null,((function (pred__23706,expr__23707,vec__23701,_,___$1,ph,pl,___$2,___$3,prev_line,vec__23702,___$4,___$5,ch,cl,___$6,___$7,curr_line,should_turn,vec__23700,value,ori,prev,curr,act,af,low){
return (function (p__23709){var vec__23710 = p__23709;var ___$8 = cljs.core.nth.call(null,vec__23710,(0),null);var ___$9 = cljs.core.nth.call(null,vec__23710,(1),null);var high = cljs.core.nth.call(null,vec__23710,(2),null);var ___$10 = cljs.core.nth.call(null,vec__23710,(3),null);var ___$11 = cljs.core.nth.call(null,vec__23710,(4),null);var ___$12 = cljs.core.nth.call(null,vec__23710,(5),null);return high;
});})(pred__23706,expr__23707,vec__23701,_,___$1,ph,pl,___$2,___$3,prev_line,vec__23702,___$4,___$5,ch,cl,___$6,___$7,curr_line,should_turn,vec__23700,value,ori,prev,curr,act,af,low))
,cljs.core.take.call(null,(3),ori)));
} else
{if(cljs.core.truth_(pred__23706.call(null,new cljs.core.Keyword(null,"sell","sell",-1949004143),expr__23707)))
{return cljs.core.apply.call(null,cljs.core.min,cljs.core.map.call(null,((function (pred__23706,expr__23707,vec__23701,_,___$1,ph,pl,___$2,___$3,prev_line,vec__23702,___$4,___$5,ch,cl,___$6,___$7,curr_line,should_turn,vec__23700,value,ori,prev,curr,act,af,low){
return (function (p__23711){var vec__23712 = p__23711;var ___$8 = cljs.core.nth.call(null,vec__23712,(0),null);var ___$9 = cljs.core.nth.call(null,vec__23712,(1),null);var ___$10 = cljs.core.nth.call(null,vec__23712,(2),null);var low__$1 = cljs.core.nth.call(null,vec__23712,(3),null);var ___$11 = cljs.core.nth.call(null,vec__23712,(4),null);var ___$12 = cljs.core.nth.call(null,vec__23712,(5),null);return low__$1;
});})(pred__23706,expr__23707,vec__23701,_,___$1,ph,pl,___$2,___$3,prev_line,vec__23702,___$4,___$5,ch,cl,___$6,___$7,curr_line,should_turn,vec__23700,value,ori,prev,curr,act,af,low))
,cljs.core.take.call(null,(3),ori)));
} else
{throw (new Error(("No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__23707))));
}
}
})():(value + (af * (pl - value))));var next_af = (function (){var pred__23713 = cljs.core._EQ_;var expr__23714 = act;if(cljs.core.truth_(pred__23713.call(null,new cljs.core.Keyword(null,"buy","buy",-794379565),expr__23714)))
{if(should_turn)
{return 0.02;
} else
{if((ch > ph))
...
{if(cljs.core.truth_(pred__23713.call(null,new cljs.core.Keyword(null,"sell","sell",-1949004143),expr__23714)))
{if(should_turn)
{return 0.02;
} else
{if((cl < pl))
...
{if(cljs.core.truth_(pred__23713.call(null,new cljs.core.Keyword(null,"else","else",-1508377146),expr__23714)))
{return af;
} else
{throw (new Error(("No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__23714))));
}
}
}
})();var next_act = ((should_turn)?(function (){var pred__23716 = cljs.core._EQ_;var expr__23717 = act;if(cljs.core.truth_(pred__23716.call(null,new cljs.core.Keyword(null,"buy","buy",-794379565),expr__23717)))
{return new cljs.core.Keyword(null,"sell","sell",-1949004143);
} else
{if(cljs.core.truth_(pred__23716.call(null,new cljs.core.Keyword(null,"sell","sell",-1949004143),expr__23717)))
{return new cljs.core.Keyword(null,"buy","buy",-794379565);
} else
{throw (new Error(("No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__23717))));
}
}
...
* 累積/派發線
*/
stock.formula.AccDist = (function AccDist(kline){return cljs.core.reductions.call(null,cljs.core._PLUS_,(0),cljs.core.map.call(null,(function (p__23721){var vec__23722 = p__23721;var _ = cljs.core.nth.call(null,vec__23722,(0),null);var open = cljs.core.nth.call(null,vec__23722,(1),null);var high = cljs.core.nth.call(null,vec__23722,(2),null);var low = cljs.core.nth.call(null,vec__23722,(3),null);var close = cljs.core.nth.call(null,vec__23722,(4),null);var volume = cljs.core.nth.call(null,vec__23722,(5),null);if(cljs.core._EQ_.call(null,high,low))
{return (0);
} else
...
* 蔡金指標
*/
stock.formula.Chaikin = (function Chaikin(n,m,kline){return cljs.core.map.call(null,(function (p1__23723_SHARP_,p2__23724_SHARP_){return (p1__23723_SHARP_ - p2__23724_SHARP_);
...
*/
stock.formula.EOM = (function EOM(n,kline){var mid_move = cljs.core.map.call(null,(function (p1__23725_SHARP_,p2__23726_SHARP_){return (p1__23725_SHARP_ - p2__23726_SHARP_);
...
return (function (p__23731){var vec__23732 = p__23731;var _ = cljs.core.nth.call(null,vec__23732,(0),null);var ___$1 = cljs.core.nth.call(null,vec__23732,(1),null);var high = cljs.core.nth.call(null,vec__23732,(2),null);var low = cljs.core.nth.call(null,vec__23732,(3),null);var ___$2 = cljs.core.nth.call(null,vec__23732,(4),null);var volume = cljs.core.nth.call(null,vec__23732,(5),null);return (volume / (high - low));
});})(mid_move))
,kline);var eom = cljs.core.map.call(null,((function (mid_move,BoxRatio){
return (function (p1__23727_SHARP_,p2__23728_SHARP_){return (p1__23727_SHARP_ / p2__23728_SHARP_);
});})(mid_move,BoxRatio))
...
{var group = cljs.core.take.call(null,n,kline);var vec__23738 = cljs.core.first.call(null,group);var _ = cljs.core.nth.call(null,vec__23738,(0),null);var ___$1 = cljs.core.nth.call(null,vec__23738,(1),null);var ___$2 = cljs.core.nth.call(null,vec__23738,(2),null);var ___$3 = cljs.core.nth.call(null,vec__23738,(3),null);var ct = cljs.core.nth.call(null,vec__23738,(4),null);var ___$4 = cljs.core.nth.call(null,vec__23738,(5),null);var L = cljs.core.apply.call(null,cljs.core.min,cljs.core.map.call(null,((function (group,vec__23738,_,___$1,___$2,___$3,ct,___$4){
return (function (p__23739){var vec__23740 = p__23739;var ___$5 = cljs.core.nth.call(null,vec__23740,(0),null);var ___$6 = cljs.core.nth.call(null,vec__23740,(1),null);var ___$7 = cljs.core.nth.call(null,vec__23740,(2),null);var low = cljs.core.nth.call(null,vec__23740,(3),null);var ___$8 = cljs.core.nth.call(null,vec__23740,(4),null);var ___$9 = cljs.core.nth.call(null,vec__23740,(5),null);return low;
});})(group,vec__23738,_,___$1,___$2,___$3,ct,___$4))
,group));var H = cljs.core.apply.call(null,cljs.core.max,cljs.core.map.call(null,((function (group,vec__23738,_,___$1,___$2,___$3,ct,___$4,L){
return (function (p__23741){var vec__23742 = p__23741;var ___$5 = cljs.core.nth.call(null,vec__23742,(0),null);var ___$6 = cljs.core.nth.call(null,vec__23742,(1),null);var high = cljs.core.nth.call(null,vec__23742,(2),null);var ___$7 = cljs.core.nth.call(null,vec__23742,(3),null);var ___$8 = cljs.core.nth.call(null,vec__23742,(4),null);var ___$9 = cljs.core.nth.call(null,vec__23742,(5),null);return high;
});})(group,vec__23738,_,___$1,___$2,___$3,ct,___$4,L))
,group));var v = ((((ct - L) * ((1) / (H - L))) * (100)) | (0));return cljs.core.cons.call(null,v,(new cljs.core.LazySeq(null,((function (group,vec__23738,_,___$1,___$2,___$3,ct,___$4,L,H,v){
return (function (){return rsv_seq.call(null,n,cljs.core.rest.call(null,kline));
});})(group,vec__23738,_,___$1,___$2,___$3,ct,___$4,L,H,v))
,null,null)));
} else
{return null;
}
...
return (function (p__23745,up_offset){var vec__23746 = p__23745;var prev = cljs.core.nth.call(null,vec__23746,(0),null);var ran = cljs.core.nth.call(null,vec__23746,(1),null);var max_v = (prev + (((up_offset > (0)))?ran:(ran / (2))));var min_v = (prev - (((up_offset < (0)))?ran:(ran / (2))));if(((max_v > up_offset)) && ((up_offset > min_v)))
