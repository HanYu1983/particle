...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_19872 = (0);while(true){
var m_19873 = cljs.core.async.impl.dispatch.tasks.pop();if((m_19873 == null))
{} else
{m_19873.call(null);
if((count_19872 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__19874 = (count_19872 + (1));
count_19872 = G__19874;
continue;
}
} else
{}
