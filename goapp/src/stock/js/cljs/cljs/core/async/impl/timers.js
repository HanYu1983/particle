...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_19792 = (0);while(true){
if((i_19792 < arr.length))
{(arr[i_19792] = null);
{
var G__19793 = (i_19792 + (1));
i_19792 = G__19793;
continue;
}
} else
...
{var i_19799 = (self__.level + (1));while(true){
if((i_19799 <= (new_level + (1))))
{(update[i_19799] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_19801 = (0);while(true){
if((i_19801 <= self__.level))
{var links_19802 = (update[i_19801]).forward;if(((links_19802[i_19801]) === x__$1))
{(links_19802[i_19801] = (x__$1.forward[i_19801]));
{
