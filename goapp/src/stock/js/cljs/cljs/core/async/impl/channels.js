...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t19878 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t19878 = (function (val,box,meta19879){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t19878.cljs$lang$type = true;
cljs.core.async.impl.channels.t19878.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t19878";
cljs.core.async.impl.channels.t19878.cljs$lang$ctorPrWriter = (function (this__4118__auto__,writer__4119__auto__,opt__4120__auto__){return cljs.core._write.call(null,writer__4119__auto__,"cljs.core.async.impl.channels/t19878");
});
cljs.core.async.impl.channels.t19878.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t19878.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19880){var self__ = this;
var _19880__$1 = this;return self__.meta19879;
});
cljs.core.async.impl.channels.t19878.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19880,meta19879__$1){var self__ = this;
var _19880__$1 = this;return (new cljs.core.async.impl.channels.t19878(self__.val,self__.box,meta19879__$1));
});
cljs.core.async.impl.channels.__GT_t19878 = (function __GT_t19878(val__$1,box__$1,meta19879){return (new cljs.core.async.impl.channels.t19878(val__$1,box__$1,meta19879));
});
}
return (new cljs.core.async.impl.channels.t19878(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj19882 = {};return obj19882;
})();
...
{}
while(true){
var taker_19883 = self__.takes.pop();if((taker_19883 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19883))
{var take_cb_19884 = cljs.core.async.impl.protocols.commit.call(null,taker_19883);var val_19885 = (cljs.core.truth_((function (){var and__3539__auto__ = self__.buf;if(cljs.core.truth_(and__3539__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3539__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19884,val_19885,taker_19883,this$__$1){
return (function (){return take_cb_19884.call(null,val_19885);
});})(take_cb_19884,val_19885,taker_19883,this$__$1))
);
} else
{}
{
...
{} else
{var putter_19886 = self__.puts.pop();if((putter_19886 == null))
{} else
{var put_handler_19887 = putter_19886.handler;var val_19888 = putter_19886.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_19887))
{var put_cb_19889 = cljs.core.async.impl.protocols.commit.call(null,put_handler_19887);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_19889,put_handler_19887,val_19888,putter_19886,_,retval,this$__$1){
return (function (){return put_cb_19889.call(null,true);
});})(put_cb_19889,put_handler_19887,val_19888,putter_19886,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_19888)))
...
{var taker_19890 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19890))
{var take_cb_19891 = cljs.core.async.impl.protocols.commit.call(null,taker_19890);var val_19892__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19891,val_19892__$1,taker_19890,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_19891.call(null,val_19892__$1);
});})(take_cb_19891,val_19892__$1,taker_19890,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_19893 = self__.puts.pop();if((putter_19893 == null))
{} else
{var put_handler_19894 = putter_19893.handler;var val_19895 = putter_19893.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_19894))
{var put_cb_19896 = cljs.core.async.impl.protocols.commit.call(null,put_handler_19894);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_19896,put_handler_19894,val_19895,putter_19893,this$__$1){
return (function (){return put_cb_19896.call(null,true);
});})(put_cb_19896,put_handler_19894,val_19895,putter_19893,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__19901 = null;
var G__19901__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e19899){var t = e19899;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__19901__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e19900){var t = e19900;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__19901 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__19901__1.call(this,buf__$1);
case 2:
return G__19901__2.call(this,buf__$1,val);
}
