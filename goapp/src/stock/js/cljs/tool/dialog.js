...
}),cljs.core.map.call(null,(function (p1__15490_SHARP_){return cljs.core.partition.call(null,length,length,null,p1__15490_SHARP_);
...
tool.dialog.step = (function step(p__15491){var map__15496 = p__15491;var map__15496__$1 = ((cljs.core.seq_QMARK_.call(null,map__15496))?cljs.core.apply.call(null,cljs.core.hash_map,map__15496):map__15496);var ctx = map__15496__$1;var state = cljs.core.get.call(null,map__15496__$1,new cljs.core.Keyword(null,"state","state",-1988618099));var curr_idx = cljs.core.get.call(null,map__15496__$1,new cljs.core.Keyword(null,"curr-idx","curr-idx",784577584));var curr_line = cljs.core.get.call(null,map__15496__$1,new cljs.core.Keyword(null,"curr-line","curr-line",277562410));var max_line = cljs.core.get.call(null,map__15496__$1,new cljs.core.Keyword(null,"max-line","max-line",-919688481));var message = cljs.core.get.call(null,map__15496__$1,new cljs.core.Keyword(null,"message","message",-406056002));var request_next = cljs.core.get.call(null,map__15496__$1,new cljs.core.Keyword(null,"request-next","request-next",-1281096497));var pred__15497 = cljs.core._EQ_;var expr__15498 = state;if(cljs.core.truth_(pred__15497.call(null,new cljs.core.Keyword(null,"typing","typing",1090632888),expr__15498)))
...
{if(cljs.core.truth_(pred__15497.call(null,new cljs.core.Keyword(null,"wait","wait",-260664777),expr__15498)))
{if(cljs.core.truth_(request_next))
...
{if(cljs.core.truth_(pred__15497.call(null,new cljs.core.Keyword(null,"next","next",-117701485),expr__15498)))
...
tool.dialog.showstr = (function showstr(p__15500){var map__15502 = p__15500;var map__15502__$1 = ((cljs.core.seq_QMARK_.call(null,map__15502))?cljs.core.apply.call(null,cljs.core.hash_map,map__15502):map__15502);var ctx = map__15502__$1;var curr_idx = cljs.core.get.call(null,map__15502__$1,new cljs.core.Keyword(null,"curr-idx","curr-idx",784577584));var curr_line = cljs.core.get.call(null,map__15502__$1,new cljs.core.Keyword(null,"curr-line","curr-line",277562410));var max_line = cljs.core.get.call(null,map__15502__$1,new cljs.core.Keyword(null,"max-line","max-line",-919688481));var message = cljs.core.get.call(null,map__15502__$1,new cljs.core.Keyword(null,"message","message",-406056002));var prevcount = cljs.core.mod.call(null,curr_line,max_line);var showstr__$1 = cljs.core.reduce.call(null,((function (prevcount,map__15502,map__15502__$1,ctx,curr_idx,curr_line,max_line,message){
...
});})(prevcount,map__15502,map__15502__$1,ctx,curr_idx,curr_line,max_line,message))
