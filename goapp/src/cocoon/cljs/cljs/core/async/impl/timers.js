...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_21790 = (0);while(true){
if((i_21790 < arr.length))
{(arr[i_21790] = null);
{
...
{var i_21797 = (self__.level + (1));while(true){
if((i_21797 <= (new_level + (1))))
{(update[i_21797] = self__.header);
{
var G__21798 = (i_21797 + (1));
i_21797 = G__21798;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_21799 = (0);while(true){
if((i_21799 <= self__.level))
{var links_21800 = (update[i_21799]).forward;if(((links_21800[i_21799]) === x__$1))
{(links_21800[i_21799] = (x__$1.forward[i_21799]));
{
var G__21801 = (i_21799 + (1));
i_21799 = G__21801;
continue;
}
} else
{{
var G__21802 = (i_21799 + (1));
i_21799 = G__21802;
continue;
}
}
