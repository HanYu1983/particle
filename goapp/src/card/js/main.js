...
Main.prototype = {
	onHtmlClick: function(type,params) {
		...
		case "onPokerClick":
			...
			org_puremvc_haxe_patterns_facade_Facade.getInstance().sendNotification(per_vic_pureMVCref_tableGameModel_controller_MainController.create_item,pokerdata);
			break;
		}
