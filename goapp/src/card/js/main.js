...
Main.changeIndex = function(cardId) {
	try {
		...
		if( js_Boot.__instanceof(e,String) ) {
			haxe_Log.trace(e,{ fileName : "Main.hx", lineNumber : 464, className : "Main", methodName : "changeIndex"});
		} else throw(e);
	}
};
...
Main.getCardImageUrlWithPackage = function(name,key) {
	...
	haxe_Log.trace(name,{ fileName : "Main.hx", lineNumber : 579, className : "Main", methodName : "getCardImageUrlWithPackage", customParams : [key]});
	haxe_Log.trace(Reflect.field(Main.cardPackages,"army"),{ fileName : "Main.hx", lineNumber : 580, className : "Main", methodName : "getCardImageUrlWithPackage"});
	if(cpkg == null) {
