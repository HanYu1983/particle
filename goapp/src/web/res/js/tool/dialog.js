...
}),cljs.core.map.call(null,(function (p1__10638_SHARP_){return cljs.core.partition.call(null,length,length,null,p1__10638_SHARP_);
...
tool.dialog.step = (function step(p__10639){var map__10644 = p__10639;var map__10644__$1 = ((cljs.core.seq_QMARK_.call(null,map__10644))?cljs.core.apply.call(null,cljs.core.hash_map,map__10644):map__10644);var ctx = map__10644__$1;var state = cljs.core.get.call(null,map__10644__$1,new cljs.core.Keyword(null,"state","state",-1988618099));var curr_idx = cljs.core.get.call(null,map__10644__$1,new cljs.core.Keyword(null,"curr-idx","curr-idx",784577584));var curr_line = cljs.core.get.call(null,map__10644__$1,new cljs.core.Keyword(null,"curr-line","curr-line",277562410));var max_line = cljs.core.get.call(null,map__10644__$1,new cljs.core.Keyword(null,"max-line","max-line",-919688481));var message = cljs.core.get.call(null,map__10644__$1,new cljs.core.Keyword(null,"message","message",-406056002));var request_next = cljs.core.get.call(null,map__10644__$1,new cljs.core.Keyword(null,"request-next","request-next",-1281096497));var pred__10645 = cljs.core._EQ_;var expr__10646 = state;if(cljs.core.truth_(pred__10645.call(null,new cljs.core.Keyword(null,"typing","typing",1090632888),expr__10646)))
...
{if(cljs.core.truth_(pred__10645.call(null,new cljs.core.Keyword(null,"wait","wait",-260664777),expr__10646)))
{if(cljs.core.truth_(request_next))
...
{if(cljs.core.truth_(pred__10645.call(null,new cljs.core.Keyword(null,"next","next",-117701485),expr__10646)))
...
tool.dialog.showstr = (function showstr(p__10648){var map__10650 = p__10648;var map__10650__$1 = ((cljs.core.seq_QMARK_.call(null,map__10650))?cljs.core.apply.call(null,cljs.core.hash_map,map__10650):map__10650);var ctx = map__10650__$1;var curr_idx = cljs.core.get.call(null,map__10650__$1,new cljs.core.Keyword(null,"curr-idx","curr-idx",784577584));var curr_line = cljs.core.get.call(null,map__10650__$1,new cljs.core.Keyword(null,"curr-line","curr-line",277562410));var max_line = cljs.core.get.call(null,map__10650__$1,new cljs.core.Keyword(null,"max-line","max-line",-919688481));var message = cljs.core.get.call(null,map__10650__$1,new cljs.core.Keyword(null,"message","message",-406056002));var prevcount = cljs.core.mod.call(null,curr_line,max_line);var showstr__$1 = cljs.core.reduce.call(null,((function (prevcount,map__10650,map__10650__$1,ctx,curr_idx,curr_line,max_line,message){
...
});})(prevcount,map__10650,map__10650__$1,ctx,curr_idx,curr_line,max_line,message))
