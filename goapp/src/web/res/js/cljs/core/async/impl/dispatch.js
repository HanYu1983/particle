...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12166 = (0);while(true){
var m_12167 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12167 == null))
{} else
{m_12167.call(null);
if((count_12166 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12168 = (count_12166 + (1));
count_12166 = G__12168;
continue;
}
} else
{}
