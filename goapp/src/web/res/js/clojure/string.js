...
{{
var G__10651 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10651;
continue;
}
} else
...
{var pred__10655 = cljs.core._EQ_;var expr__10656 = limit;if(cljs.core.truth_(pred__10655.call(null,(1),expr__10656)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10655.call(null,(2),expr__10656)))
...
var G__10658 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10659 = (limit__$1 - (1));
var G__10660 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__10658;
limit__$1 = G__10659;
parts = G__10660;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10662 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10662))
{var replacement_10663 = temp__4124__auto___10662;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10663)));
} else
{buffer.append(ch);
}
{
var G__10664 = (index + (1));
index = G__10664;
continue;
}
}
