...
test.stock_game.Order.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4139__auto__,k15907,else__4140__auto__){var self__ = this;
var this__4139__auto____$1 = this;var G__15909 = (((k15907 instanceof cljs.core.Keyword))?k15907.fqn:null);switch (G__15909) {
case "time":
return self__.time;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k15907,else__4140__auto__);
...
test.stock_game.Order.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4144__auto__,k__4145__auto__,G__15906){var self__ = this;
var this__4144__auto____$1 = this;var pred__15910 = cljs.core.keyword_identical_QMARK_;var expr__15911 = k__4145__auto__;if(cljs.core.truth_(pred__15910.call(null,new cljs.core.Keyword(null,"id","id",-1388402092),expr__15911)))
{return (new test.stock_game.Order(G__15906,self__.type,self__.price,self__.cnt,self__.time,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__15910.call(null,new cljs.core.Keyword(null,"type","type",1174270348),expr__15911)))
{return (new test.stock_game.Order(self__.id,G__15906,self__.price,self__.cnt,self__.time,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__15910.call(null,new cljs.core.Keyword(null,"price","price",22129180),expr__15911)))
{return (new test.stock_game.Order(self__.id,self__.type,G__15906,self__.cnt,self__.time,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__15910.call(null,new cljs.core.Keyword(null,"cnt","cnt",283978798),expr__15911)))
{return (new test.stock_game.Order(self__.id,self__.type,self__.price,G__15906,self__.time,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__15910.call(null,new cljs.core.Keyword(null,"time","time",1385887882),expr__15911)))
{return (new test.stock_game.Order(self__.id,self__.type,self__.price,self__.cnt,G__15906,self__.__meta,self__.__extmap,null));
} else
{return (new test.stock_game.Order(self__.id,self__.type,self__.price,self__.cnt,self__.time,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4145__auto__,G__15906),null));
}
}
}
}
...
test.stock_game.Order.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4136__auto__,G__15906){var self__ = this;
var this__4136__auto____$1 = this;return (new test.stock_game.Order(self__.id,self__.type,self__.price,self__.cnt,self__.time,G__15906,self__.__extmap,self__.__hash));
});
...
test.stock_game.map__GT_Order = (function map__GT_Order(G__15908){return (new test.stock_game.Order(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(G__15908),new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__15908),new cljs.core.Keyword(null,"price","price",22129180).cljs$core$IFn$_invoke$arity$1(G__15908),new cljs.core.Keyword(null,"cnt","cnt",283978798).cljs$core$IFn$_invoke$arity$1(G__15908),new cljs.core.Keyword(null,"time","time",1385887882).cljs$core$IFn$_invoke$arity$1(G__15908),null,cljs.core.dissoc.call(null,G__15908,new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"price","price",22129180),new cljs.core.Keyword(null,"cnt","cnt",283978798),new cljs.core.Keyword(null,"time","time",1385887882))));
});
test.stock_game.deal = (function deal(orders){var map__15917 = cljs.core.group_by.call(null,new cljs.core.Keyword(null,"type","type",1174270348),orders);var map__15917__$1 = ((cljs.core.seq_QMARK_.call(null,map__15917))?cljs.core.apply.call(null,cljs.core.hash_map,map__15917):map__15917);var buys = cljs.core.get.call(null,map__15917__$1,new cljs.core.Keyword(null,"buy","buy",-794379565));var sells = cljs.core.get.call(null,map__15917__$1,new cljs.core.Keyword(null,"sell","sell",-1949004143));var sortedBuys = cljs.core.sort_by.call(null,((function (map__15917,map__15917__$1,buys,sells){
...
});})(map__15917,map__15917__$1,buys,sells))
,buys);var sortedSells = cljs.core.sort_by.call(null,((function (map__15917,map__15917__$1,buys,sells,sortedBuys){
return (function (item){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"price","price",22129180).cljs$core$IFn$_invoke$arity$1(item),(- new cljs.core.Keyword(null,"time","time",1385887882).cljs$core$IFn$_invoke$arity$1(item))], null);
});})(map__15917,map__15917__$1,buys,sells,sortedBuys))
,sells);return cljs.core.iterate.call(null,((function (map__15917,map__15917__$1,buys,sells,sortedBuys,sortedSells){
return (function (p__15918){var vec__15919 = p__15918;var buys__$1 = cljs.core.nth.call(null,vec__15919,(0),null);var sells__$1 = cljs.core.nth.call(null,vec__15919,(1),null);var deals = cljs.core.nth.call(null,vec__15919,(2),null);var buy = cljs.core.first.call(null,buys__$1);var sell = cljs.core.first.call(null,sells__$1);if((new cljs.core.Keyword(null,"price","price",22129180).cljs$core$IFn$_invoke$arity$1(buy) >= new cljs.core.Keyword(null,"price","price",22129180).cljs$core$IFn$_invoke$arity$1(sell)))
{return true;
} else
{return false;
}
});})(map__15917,map__15917__$1,buys,sells,sortedBuys,sortedSells))
