...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15229 = (0);while(true){
var m_15230 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15230 == null))
{} else
{m_15230.call(null);
if((count_15229 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15231 = (count_15229 + (1));
count_15229 = G__15231;
continue;
}
} else
{}
