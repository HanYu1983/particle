...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15235 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15235 = (function (val,box,meta15236){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15235.cljs$lang$type = true;
cljs.core.async.impl.channels.t15235.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15235";
cljs.core.async.impl.channels.t15235.cljs$lang$ctorPrWriter = (function (this__4118__auto__,writer__4119__auto__,opt__4120__auto__){return cljs.core._write.call(null,writer__4119__auto__,"cljs.core.async.impl.channels/t15235");
});
cljs.core.async.impl.channels.t15235.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15235.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15237){var self__ = this;
var _15237__$1 = this;return self__.meta15236;
});
cljs.core.async.impl.channels.t15235.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15237,meta15236__$1){var self__ = this;
var _15237__$1 = this;return (new cljs.core.async.impl.channels.t15235(self__.val,self__.box,meta15236__$1));
});
cljs.core.async.impl.channels.__GT_t15235 = (function __GT_t15235(val__$1,box__$1,meta15236){return (new cljs.core.async.impl.channels.t15235(val__$1,box__$1,meta15236));
});
}
return (new cljs.core.async.impl.channels.t15235(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj15239 = {};return obj15239;
})();
...
{}
while(true){
var taker_15240 = self__.takes.pop();if((taker_15240 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15240))
{var take_cb_15241 = cljs.core.async.impl.protocols.commit.call(null,taker_15240);var val_15242 = (cljs.core.truth_((function (){var and__3539__auto__ = self__.buf;if(cljs.core.truth_(and__3539__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3539__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15241,val_15242,taker_15240,this$__$1){
return (function (){return take_cb_15241.call(null,val_15242);
});})(take_cb_15241,val_15242,taker_15240,this$__$1))
);
} else
{}
{
...
{} else
{var putter_15243 = self__.puts.pop();if((putter_15243 == null))
{} else
{var put_handler_15244 = putter_15243.handler;var val_15245 = putter_15243.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15244))
{var put_cb_15246 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15244);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15246,put_handler_15244,val_15245,putter_15243,_,retval,this$__$1){
return (function (){return put_cb_15246.call(null,true);
});})(put_cb_15246,put_handler_15244,val_15245,putter_15243,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_15245)))
...
{var taker_15247 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15247))
{var take_cb_15248 = cljs.core.async.impl.protocols.commit.call(null,taker_15247);var val_15249__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15248,val_15249__$1,taker_15247,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_15248.call(null,val_15249__$1);
});})(take_cb_15248,val_15249__$1,taker_15247,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_15250 = self__.puts.pop();if((putter_15250 == null))
{} else
{var put_handler_15251 = putter_15250.handler;var val_15252 = putter_15250.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15251))
{var put_cb_15253 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15251);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15253,put_handler_15251,val_15252,putter_15250,this$__$1){
return (function (){return put_cb_15253.call(null,true);
});})(put_cb_15253,put_handler_15251,val_15252,putter_15250,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__15258 = null;
var G__15258__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e15256){var t = e15256;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__15258__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e15257){var t = e15257;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__15258 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__15258__1.call(this,buf__$1);
case 2:
return G__15258__2.call(this,buf__$1,val);
}
