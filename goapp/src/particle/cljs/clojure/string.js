...
{{
var G__15312 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15312;
continue;
}
} else
...
{var pred__15316 = cljs.core._EQ_;var expr__15317 = limit;if(cljs.core.truth_(pred__15316.call(null,(1),expr__15317)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15316.call(null,(2),expr__15317)))
...
var G__15319 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15320 = (limit__$1 - (1));
var G__15321 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__15319;
limit__$1 = G__15320;
parts = G__15321;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___15323 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___15323))
{var replacement_15324 = temp__4124__auto___15323;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_15324)));
} else
{buffer.append(ch);
}
{
var G__15325 = (index + (1));
index = G__15325;
continue;
}
}
