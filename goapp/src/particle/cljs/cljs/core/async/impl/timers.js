...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_15149 = (0);while(true){
if((i_15149 < arr.length))
{(arr[i_15149] = null);
{
var G__15150 = (i_15149 + (1));
i_15149 = G__15150;
continue;
}
} else
...
{var i_15156 = (self__.level + (1));while(true){
if((i_15156 <= (new_level + (1))))
{(update[i_15156] = self__.header);
{
var G__15157 = (i_15156 + (1));
i_15156 = G__15157;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15158 = (0);while(true){
if((i_15158 <= self__.level))
{var links_15159 = (update[i_15158]).forward;if(((links_15159[i_15158]) === x__$1))
{(links_15159[i_15158] = (x__$1.forward[i_15158]));
{
var G__15160 = (i_15158 + (1));
i_15158 = G__15160;
continue;
}
} else
{{
var G__15161 = (i_15158 + (1));
i_15158 = G__15161;
continue;
}
}
