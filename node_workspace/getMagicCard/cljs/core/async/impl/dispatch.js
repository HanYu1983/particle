...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12299 = (0);while(true){
var m_12300 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12300 == null))
{} else
{m_12300.call(null);
if((count_12299 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12301 = (count_12299 + (1));
count_12299 = G__12301;
continue;
}
} else
{}
