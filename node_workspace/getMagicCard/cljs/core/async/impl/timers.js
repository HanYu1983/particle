...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_12219 = (0);while(true){
if((i_12219 < arr.length))
{(arr[i_12219] = null);
{
var G__12220 = (i_12219 + (1));
i_12219 = G__12220;
continue;
}
} else
...
{var i_12226 = (self__.level + (1));while(true){
if((i_12226 <= (new_level + (1))))
{(update[i_12226] = self__.header);
{
var G__12227 = (i_12226 + (1));
i_12226 = G__12227;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12228 = (0);while(true){
if((i_12228 <= self__.level))
{var links_12229 = (update[i_12228]).forward;if(((links_12229[i_12228]) === x__$1))
{(links_12229[i_12228] = (x__$1.forward[i_12228]));
{
var G__12230 = (i_12228 + (1));
i_12228 = G__12230;
continue;
}
} else
{{
var G__12231 = (i_12228 + (1));
i_12228 = G__12231;
continue;
}
}
