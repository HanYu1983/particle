...
cljs.core.doall.call(null,(function (){var iter__4292__auto__ = (function test$yoyo$readdir_$_iter__4734(s__4735){
return (new cljs.core.LazySeq(null,(function (){
var s__4735__$1 = s__4735;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__4735__$1);
if(temp__5457__auto__){
var s__4735__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__4735__$2)){
var c__4290__auto__ = cljs.core.chunk_first.call(null,s__4735__$2);
var size__4291__auto__ = cljs.core.count.call(null,c__4290__auto__);
var b__4737 = cljs.core.chunk_buffer.call(null,size__4291__auto__);
if((function (){var i__4736 = (0);
while(true){
if((i__4736 < size__4291__auto__)){
var da = cljs.core._nth.call(null,c__4290__auto__,i__4736);
cljs.core.chunk_append.call(null,b__4737,obs.onNext(da));

var G__4738 = (i__4736 + (1));
i__4736 = G__4738;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4737),test$yoyo$readdir_$_iter__4734.call(null,cljs.core.chunk_rest.call(null,s__4735__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4737),null);
}
} else {
var da = cljs.core.first.call(null,s__4735__$2);
return cljs.core.cons.call(null,obs.onNext(da),test$yoyo$readdir_$_iter__4734.call(null,cljs.core.rest.call(null,s__4735__$2)));
}
} else {
return null;
}
...
return (function (all,p__4740){
var vec__4741 = p__4740;
var k = cljs.core.nth.call(null,vec__4741,(0),null);
var cnt = cljs.core.nth.call(null,vec__4741,(1),null);
if((cnt > (0))){
...
return (function test$yoyo$parseHtml_$_iter__4744(s__4745){
return (new cljs.core.LazySeq(null,((function (group){
return (function (){
var s__4745__$1 = s__4745;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__4745__$1);
if(temp__5457__auto__){
var s__4745__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__4745__$2)){
var c__4290__auto__ = cljs.core.chunk_first.call(null,s__4745__$2);
var size__4291__auto__ = cljs.core.count.call(null,c__4290__auto__);
var b__4747 = cljs.core.chunk_buffer.call(null,size__4291__auto__);
if((function (){var i__4746 = (0);
while(true){
if((i__4746 < size__4291__auto__)){
var obj = cljs.core._nth.call(null,c__4290__auto__,i__4746);
cljs.core.chunk_append.call(null,b__4747,obs.onNext(cljs.core.apply.call(null,cljs.core.array,obj)));

var G__4748 = (i__4746 + (1));
i__4746 = G__4748;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4747),test$yoyo$parseHtml_$_iter__4744.call(null,cljs.core.chunk_rest.call(null,s__4745__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4747),null);
}
} else {
var obj = cljs.core.first.call(null,s__4745__$2);
return cljs.core.cons.call(null,obs.onNext(cljs.core.apply.call(null,cljs.core.array,obj)),test$yoyo$parseHtml_$_iter__4744.call(null,cljs.core.rest.call(null,s__4745__$2)));
}
} else {
return null;
}
...
return test.yoyo.rx.Observable.of(pkgName).map((function (p1__4750_SHARP_){
return ["yoyoDoc/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__4750_SHARP_),".html"].join('');
...
return test.yoyo.readfile.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(test.yoyo.output),cljs.core.str.cljs$core$IFn$_invoke$arity$1(pkgName),".json"].join('')).map((function (p1__4752_SHARP_){
return JSON.parse(p1__4752_SHARP_);
})).flatMap((function (p1__4753_SHARP_){
return test.yoyo.rx.Observable.from(p1__4753_SHARP_);
...
})).timeInterval().map((function (p1__4754_SHARP_){
return (p1__4754_SHARP_.value[(0)]);
...
return (new imagemin()).src([cljs.core.str.cljs$core$IFn$_invoke$arity$1(p),"/*.{gif,jpg,png,svg}"].join('')).dest("output/compress/").use(imagemin.jpegtran((function (){var obj4756 = {"progressive":false};
return obj4756;
