...
return (function (all,row){
if((row.lastIndexOf("#",(0)) === (0))){
return all;
} else {
return cljs.core.conj.call(null,all,parseRow.call(null,row));
}
});})(parseRow,rows))
,cljs.core.PersistentArrayMap.EMPTY,cljs.core.js__GT_clj.call(null,rows));
return cb.call(null,null,formated);
}));
});
test.yugioh.formatTemplate = (function test$yugioh$formatTemplate(i,cnt,strs,attr){
return cljs.core.reduce.call(null,(function (all,idx){
var mask = ((1) << idx);
if(((mask & attr) > (0))){
return cljs.core.conj.call(null,all,cljs.core.get.call(null,strs,[cljs.core.str.cljs$core$IFn$_invoke$arity$1((i + idx))].join('')));
} else {
return all;
}
...
test.yugioh.parseCDB = (function test$yugioh$parseCDB(db,cb){
return db.serialize((function (){
var output = [];
return db.each("select count(*) as cnt from datas,texts where datas.id=texts.id",((function (output){
return (function (err,row){
var total = row.cnt;
var all = cljs.core.atom.call(null,cljs.core.PersistentVector.EMPTY);
return db.each("select * from datas,texts where datas.id=texts.id",((function (total,all,output){
return (function (err__$1,row__$1){
cljs.core.swap_BANG_.call(null,all,cljs.core.conj,row__$1);
...
test.yugioh.parseFile = (function test$yugioh$parseFile(lan){
return test.yugioh.async.parallel([cljs.core.partial.call(null,test.yugioh.parseStrings,cljs.core.get_in.call(null,test.yugioh.config,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lan,new cljs.core.Keyword(null,"strings","strings",-2055406807)], null))),cljs.core.partial.call(null,test.yugioh.parseCDB,(new test.yugioh.SqliteDB(cljs.core.get_in.call(null,test.yugioh.config,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lan,new cljs.core.Keyword(null,"db","db",993250759)], null)))))],(function (err,rets){
var strs = (rets[(0)]);
var cards = (rets[(1)]);
var formatObj = ((function (strs,cards){
return (function (obj){
...
;
var formatCards = cljs.core.map.call(null,formatObj,cards);
return test.yugioh.fs.writeFile(cljs.core.get_in.call(null,test.yugioh.config,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lan,new cljs.core.Keyword(null,"output","output",-1105869043)], null)),JSON.stringify(cljs.core.clj__GT_js.call(null,formatCards),null,"\t"),((function (strs,cards,formatObj,formatCards){
return (function (err__$1){
return console.log("write file ",cljs.core.get_in.call(null,test.yugioh.config,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lan,new cljs.core.Keyword(null,"output","output",-1105869043)], null)),"!");
