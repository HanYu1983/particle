...
{return test.gundamWar.fs.writeFile((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(test.gundamWar.downloadDir)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(pageNum)+".html"),ret,(function (err__$1){if(cljs.core.truth_(err__$1))
...
test.gundamWar.downloadPages = (function downloadPages(start,cnt){return test.gundamWar.async.eachSeries(cljs.core.clj__GT_js.call(null,cljs.core.range.call(null,start,(start + cnt))),cljs.core.partial.call(null,test.gundamWar.downloadPage,(2000)),(function (err,rets){return console.log(err);
}));
});
test.gundamWar.regex_g = cljs.core.re_pattern.call(null,("<center><table width='100%'>([\\s\\S]+?)<\\/center>"));
test.gundamWar.regex_id = cljs.core.re_pattern.call(null,("<td align=[\"']?center[\"']? bgcolor=[\"']?(#\\w{6})[\"']? width=[\"']?\\d+ height=[\"']?\\d+[\"']?\\s*>\\s+(\\S+)\\s+<\\/td>"));
test.gundamWar.regex_name = cljs.core.re_pattern.call(null,("<td bgcolor=[\"']?#.{6}[\"']width=[\"']?\\d+[\"']?>(.+)<\\/td>"));
test.gundamWar.regex_belong = cljs.core.re_pattern.call(null,("<td colspan=\"3\" valign=\"top\" align=\"right\" height=\"40\">\\s+(.+)<\\/td>"));
test.gundamWar.regex_context = cljs.core.re_pattern.call(null,("<td  colspan=\"3\" valign=\"top\" align=\"left\" height=\"120\" >([\\s\\S]+?)<\\/td>"));
test.gundamWar.regex_cost = cljs.core.re_pattern.call(null,("\u570B\u529B\u8CC7\u6E90\uFF1A(\\W?\\d.?\\W?\\d? - \\d - \\d)"));
test.gundamWar.regex_atkadj = cljs.core.re_pattern.call(null,("\u6230\u9B25\u4FEE\u6B63\uFF1A(\\d) \\/ (\\d) \\/ (\\d)"));
test.gundamWar.regex_atk = cljs.core.re_pattern.call(null,("\u6230\u9B25\u529B\uFF1A(\\d+\\/?\\d?) \\/ (\\d+\\/?\\d?) \\/ (\\d+\\/?\\d?)"));
test.gundamWar.regex_area = cljs.core.re_pattern.call(null,("\u5730\u5F62\u9069\u6027\uFF1A([\u5B87\u5B99\u30FB\u5730\u7403]+)"));
test.gundamWar.regex_image = cljs.core.re_pattern.call(null,("card\\.php\\?img=image\\/\\d+\\/(\\d+\\.jpg)"));
test.gundamWar.parseGroup = (function parseGroup(group){var ids = cljs.core.map.call(null,cljs.core.rest,cljs.core.re_seq.call(null,test.gundamWar.regex_id,group));var images = cljs.core.map.call(null,cljs.core.second,cljs.core.re_seq.call(null,test.gundamWar.regex_image,group));var names = cljs.core.map.call(null,cljs.core.second,cljs.core.re_seq.call(null,test.gundamWar.regex_name,group));var pkgs = cljs.core.map.call(null,cljs.core.second,cljs.core.re_seq.call(null,test.gundamWar.regex_belong,group));var context = cljs.core.map.call(null,cljs.core.second,cljs.core.re_seq.call(null,test.gundamWar.regex_context,group));if(cljs.core.truth_(cljs.core.apply.call(null,cljs.core._EQ_,cljs.core.map.call(null,cljs.core.count,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [ids,names,pkgs,context], null)))))
{} else
{throw "data lost!!";
}
...
})],(function (err,ret){if(cljs.core.truth_(err))
{return console.log(err);
} else
{return test.gundamWar.fs.writeFile(test.gundamWar.output,JSON.stringify(ret),(function (err__$1){if(cljs.core.truth_(err__$1))
