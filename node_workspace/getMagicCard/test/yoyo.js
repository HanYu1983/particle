...
{cljs.core.doall.call(null,(function (){var iter__4276__auto__ = (function iter__5841(s__5842){return (new cljs.core.LazySeq(null,(function (){var s__5842__$1 = s__5842;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__5842__$1);if(temp__4126__auto__)
{var s__5842__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__5842__$2))
{var c__4274__auto__ = cljs.core.chunk_first.call(null,s__5842__$2);var size__4275__auto__ = cljs.core.count.call(null,c__4274__auto__);var b__5844 = cljs.core.chunk_buffer.call(null,size__4275__auto__);if((function (){var i__5843 = (0);while(true){
if((i__5843 < size__4275__auto__))
{var da = cljs.core._nth.call(null,c__4274__auto__,i__5843);cljs.core.chunk_append.call(null,b__5844,obs.onNext(da));
{
var G__5845 = (i__5843 + (1));
i__5843 = G__5845;
continue;
}
} else
...
{var da = cljs.core.first.call(null,s__5842__$2);return cljs.core.cons.call(null,obs.onNext(da),iter__5841.call(null,cljs.core.rest.call(null,s__5842__$2)));
}
} else
{return null;
}
...
{var G__5847 = obs;G__5847.onNext(data);
G__5847.onCompleted();
return G__5847;
}
}));
...
return (function (all,p__5850){var vec__5851 = p__5850;var k = cljs.core.nth.call(null,vec__5851,(0),null);var cnt = cljs.core.nth.call(null,vec__5851,(1),null);if((cnt > (0)))
...
return (function iter__5856(s__5857){return (new cljs.core.LazySeq(null,((function (group){
return (function (){var s__5857__$1 = s__5857;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__5857__$1);if(temp__4126__auto__)
{var s__5857__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__5857__$2))
{var c__4274__auto__ = cljs.core.chunk_first.call(null,s__5857__$2);var size__4275__auto__ = cljs.core.count.call(null,c__4274__auto__);var b__5859 = cljs.core.chunk_buffer.call(null,size__4275__auto__);if((function (){var i__5858 = (0);while(true){
if((i__5858 < size__4275__auto__))
{var obj = cljs.core._nth.call(null,c__4274__auto__,i__5858);cljs.core.chunk_append.call(null,b__5859,obs.onNext(cljs.core.apply.call(null,cljs.core.array,obj)));
{
var G__5860 = (i__5858 + (1));
i__5858 = G__5860;
continue;
}
} else
...
{var obj = cljs.core.first.call(null,s__5857__$2);return cljs.core.cons.call(null,obs.onNext(cljs.core.apply.call(null,cljs.core.array,obj)),iter__5856.call(null,cljs.core.rest.call(null,s__5857__$2)));
}
} else
{return null;
}
...
{var G__5862 = obs;G__5862.onCompleted();
return G__5862;
}
}));
}));
...
test.yoyo.parseInfo = (function parseInfo(pkgName){return test.yoyo.rx.Observable.of(pkgName).map((function (p1__5863_SHARP_){return ("yoyoDoc/"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__5863_SHARP_)+".html");
})).flatMap(test.yoyo.readfile).flatMap(test.yoyo.parseHtml).reduce((function (acc,x){var G__5865 = acc;G__5865.push(x);
return G__5865;
...
test.yoyo.getImage = (function getImage(pkgName){return test.yoyo.readfile.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(test.yoyo.output)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(pkgName)+".json")).map((function (p1__5866_SHARP_){return JSON.parse(p1__5866_SHARP_);
})).flatMap((function (p1__5867_SHARP_){return test.yoyo.rx.Observable.from(p1__5867_SHARP_);
})).map((function (p1__5868_SHARP_){return (p1__5868_SHARP_[(0)]);
