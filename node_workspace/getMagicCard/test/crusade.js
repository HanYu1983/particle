...
test.crusade.fetchImage = (function fetchImage(p__5183,cb){var vec__5185 = p__5183;var prod = cljs.core.nth.call(null,vec__5185,(0),null);var id = cljs.core.nth.call(null,vec__5185,(1),null);console.log(("fetchImage"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(prod)+"_"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)+".jpg"));
return test.crusade.request.call(null,test.crusade.imageUrl.call(null,prod,id)).pipe(test.crusade.fs.createWriteStream((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(test.crusade.outputImageDir)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(prod)+"_"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)+".jpg"))).on("close",((function (vec__5185,prod,id){
return (function (){console.log("ok for fetchImage",id);
return setTimeout(cb,(3000));
});})(vec__5185,prod,id))
);
});
test.crusade.fetchAllImage = (function fetchAllImage(){return test.crusade.async.waterfall([(function (cb){return test.crusade.async.map(cljs.core.clj__GT_js.call(null,cljs.core.map.call(null,(function (p1__5186_SHARP_){return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(test.crusade.output)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__5186_SHARP_)+".json");
}),test.crusade.prods)),lib.tool.getFile,cb);
}),(function (datas,cb){var alls = cljs.core.reduce.call(null,(function (p1__5189_SHARP_,p2__5190_SHARP_){return cljs.core.concat.call(null,p1__5189_SHARP_,p2__5190_SHARP_);
}),cljs.core.List.EMPTY,cljs.core.map.call(null,(function (p1__5188_SHARP_){return p1__5188_SHARP_.data;
}),cljs.core.map.call(null,(function (p1__5187_SHARP_){return JSON.parse(p1__5187_SHARP_);
